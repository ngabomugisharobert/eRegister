...
data class GroupMovement(
    ...
    @ColumnInfo(name = "grp_id") val grp_name: Int,
...
)
{
    fun toString(phoneId:String): String {
        return " { grp_mv_id : $phoneId-$grp_mv_id, grp_id :'$grp_name', grp_mv_card :'$grp_mv_card', grp_mv_type : '$grp_mv_type', grp_mv_time : '$grp_mv_time', timestamp : '$timestamp' }"
    }
}